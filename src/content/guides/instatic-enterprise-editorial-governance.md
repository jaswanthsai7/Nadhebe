...
heroImage: "/images/instatic-governance-hero.png"
heroAlt: "Vintage editorial collage illustration of client permissions, user profiles, and keys on a Sage Green background"
draft: false
topic: "Instatic"
isPillar: false
...
* See agency migration cost breakdowns in [Case Study: Migrating 25 Client Sites from Webflow to Instatic](/guides/webflow-to-instatic-migration-savings).
